...
class BOP2020M(Instrument):
    ...
    current = RampCommand("Current", increment=0.1, delay=20e-3, get_string=":CURR?", set_string=":CURR:LEV:IMM {:g}", value_range=(-20,20))
    voltage = RampCommand("Voltage", increment=0.1, delay=20e-3, get_string=":VOLT?", set_string=":VOLT:LEV:IMM {:g}", value_range=(-20,20))
