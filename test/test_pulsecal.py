...
class SingleQubitCalTestCase(unittest.TestCase):
    ...
    * RamseyCalibration
    ...
    def _setUp(self):
        ...
        cl.set_measure(self.q, self.aps2, self.x6_1.ch("integrated-1-1"), generator=self.holz2)
    ...
    def test_rabi_amp(self):
        ...
        """
        pce = RabiAmpCalibration(self.q, do_plotting=False, num_steps=20, sample_name="Testing123")
    ...
    def run_ramsey(self, set_source = True):
        ...
        ramsey_cal = RamseyCalibration(self.q, do_plotting=False, added_detuning = 0e3, 
    ...
    def test_pi_phase_estimation(self):
        ...
        numPulses = 9
        self.q.pulse_params['piAmp'] = 0.4
        self.q.pulse_params['pi2Amp'] = 0.2
        ...
        for quad in ['real']: # TODO: fix this for other quadratures
            pi_cal = PiCalibration(self.q, do_plotting=False, num_pulses=numPulses, quad=quad, sample_name="TestingPi")
            pi_cal.set_fake_data(self.x6_1, ideal_data)
            pi_cal.calibrate()
    ...
    def test_drag(self):
        ...
        drag_cal = DRAGCalibration(self.q, do_plotting=False, deltas = deltas_0, num_pulses = pulses_0, sample_name="TestingDrag")
        drag_cal.set_fake_data(self.x6_1, ideal_data)
        drag_cal.calibrate()

        self.assertAlmostEqual(drag_cal.opt_drag, ideal_drag, places=2)
        self.assertAlmostEqual(drag_cal.opt_drag, self.q.pulse_params['drag_scaling'], places=2)
