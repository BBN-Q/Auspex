...
class RamseyCalibration(QubitCalibration):
    ...
    def init_plots(self):
        plot = ManualPlotter("Ramsey Fits", x_label='Time (s)', y_label='Amplitude (Arb. Units)')
        plot.add_data_trace("Data 1", {'color': colors[0]})
        plot.add_fit_trace("Fit 1", {'color': colors[0]})
        plot.add_data_trace("Data 2", {'color': colors[1]})
        plot.add_fit_trace("Fit 2", {'color': colors[1]})
        self.plot = plot
        return [plot]
