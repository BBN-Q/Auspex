...
def ntron_pulse(rise_time=200e-12, fall_time=1.0e-9, sample_rate=12e9):
...
if __name__ == '__main__':
    ...
    segment_ids = []
    fall_times = np.arange(0.25e-9, 4.10e-9, 1/12e9)
    for fall_time in fall_times:
        waveform   = ntron_pulse(fall_time=fall_time)
